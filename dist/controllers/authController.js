...
var generateJWT = function (userId, username) {
    return jsonwebtoken_1["default"].sign({ userId: userId, username: username }, process.env.JWT_SECRET, {
        expiresIn: "1h"
    });
};
var register = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, email, password, passwordConfirmation, hashedPassword, user, token, error_1;
